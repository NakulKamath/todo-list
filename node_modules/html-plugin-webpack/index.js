...
class HtmlWebpackPlugin {
  ...
  getAssetFiles(assets) {
    ...
    const filteredTypes = assetTypes.filter(assetType => assetType !== 'chunks' && assets[assetType]);
    const files = filteredTypes.reduce((fileArray, assetType) => fileArray.concat(assets[assetType]), []);
